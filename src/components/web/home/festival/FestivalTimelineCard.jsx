  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        {/* Card - Now clickable */}
        <Link href={`/festivals/${festivalSlug}`} className="flex-1">
          <div className="bg-white dark:bg-[#241B14] rounded-xl border border-[#F4B400]/15 dark:border-[#F4B400]/15 p-3 sm:p-4 hover:shadow-lg dark:hover:shadow-black/40 transition-all duration-300 group-hover:border-[#F4B400]/35 cursor-pointer">
            <div className="flex flex-wrap items-start gap-3 sm:gap-4">
              {/* Thumbnail */}
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-lg overflow-hidden flex-shrink-0">
                <Image src={festival.image} alt={festival.name} fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
              </div>
                ...
                <div className="flex flex-wrap items-start justify-between gap-2 sm:gap-3">
                  <div className="min-w-0">
                    <div className="flex items-center flex-wrap gap-1.5">
                      <h4 className="text-sm sm:text-base font-semibold text-[#3D2B1A] dark:text-[#F5EAD9] group-hover:text-[#E8742C] dark:group-hover:text-[#F4B400] transition-colors">
                        {festival.name}
                      </h4>
