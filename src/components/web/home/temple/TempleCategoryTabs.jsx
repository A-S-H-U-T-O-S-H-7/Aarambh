// components/home/TempleCategoryTabs.jsx
'use client';

import { motion } from 'framer-motion';

export default function TempleCategoryTabs({ categories, activeCategory, onCategoryChange }) {
  return (
