...
export default function AdvertisePage() {
  ...
  const whyItems = [
    {
      ...
      title: "Massive Reach",
      desc: "Connect with thousands of spiritual seekers daily",
    ...
    },
    {
      ...
      desc: "Reach spiritually inclined audience across India",
      iconBg: "bg-gold/10",
      iconColor: "text-gold",
    },
    {
      ...
      desc: "Detailed reports on ad performance and engagement",
      iconBg: "bg-divine-red/10",
      iconColor: "text-divine-red",
    },
    {
      icon: <Headphones className="w-4 h-4" />,
      title: "Dedicated Support",
      desc: "24/7 support for all your advertising needs",
      iconBg: "bg-saffron/10",
      iconColor: "text-saffron",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 via-cream-100/50 to-cream-50 dark:from-brown-950 dark:via-brown-900 dark:to-brown-950 py-4 pb-14 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-base text-brown-500 dark:text-cream-50/60 max-w-md mx-auto leading-relaxed">
            Reach thousands of spiritual seekers across India. Choose from our variety of advertising options.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          >
            <div className="bg-white/70 dark:bg-brown-800/70 backdrop-blur-xl border border-gold/20 dark:border-gold/10 rounded-2xl shadow-xl shadow-saffron/5 dark:shadow-none p-7">
              <h2 className="text-xl font-bold text-brown-900 dark:text-cream-50 mb-6">
                Why advertise with Aarambh TV?
              </h2>
              <div className="space-y-5">
                {whyItems.map((item) => (
                  <div key={item.title} className="flex items-start gap-3.5">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-brown-800 dark:text-cream-50/90 mb-0.5">
                        {item.title}
                      </p>
                      <p className="text-xs text-brown-500 dark:text-cream-50/60 leading-relaxed">
                        {item.desc}
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-8 h-1.5 w-full rounded-full bg-gradient-to-r from-saffron via-gold to-saffron opacity-60" />
            </div>

            <div className="bg-gradient-to-br from-saffron to-gold rounded-2xl p-6 text-white shadow-xl shadow-saffron/20 dark:shadow-saffron/10">
                ...
                {isSuccess ? (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="relative">
                          <Building className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-brown-400" />
                          <input
                            type="text"
                            name="companyName"
                      ...
                      <div>
                        <label className="block text-xs font-semibold uppercase tracking-wider text-brown-500 dark:text-cream-50/50 mb-1.5">
                          Contact person <span className="text-saffron">*</span>
                        </label>
                        <div className="relative">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Globe className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-brown-400" />
                        <input
                          type="url"
                          name="website"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-semibold uppercase tracking-wider text-brown-500 dark:text-cream-50/50 mb-1.5">
                          Ad type <span className="text-saffron">*</span>
                        </label>
                        <select
                          name="adType"
                          ...
                          onChange={handleChange}
                          required
                          className="w-full px-4 py-2.5 text-sm rounded-xl bg-white dark:bg-brown-900 text-brown-900 dark:text-cream-50 border border-gold/20 dark:border-gold/10 focus:outline-none focus:border-saffron focus:ring-2 focus:ring-saffron/20 transition-all duration-200"
                        >
                          {adTypes.map((t) => (
                      ...
                      <div>
                        <label className="block text-xs font-semibold uppercase tracking-wider text-brown-500 dark:text-cream-50/50 mb-1.5">
                          Budget range <span className="text-saffron">*</span>
                        </label>
                        <select
                          name="budget"
                    ...
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wider text-brown-500 dark:text-cream-50/50 mb-1.5">
                        Campaign duration <span className="text-saffron">*</span>
                      </label>
                      <select
                        name="duration"
                    ...
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wider text-brown-500 dark:text-cream-50/50 mb-1.5">
                        Message / requirements <span className="text-saffron">*</span>
                      </label>
                      <textarea
                        name="message"
