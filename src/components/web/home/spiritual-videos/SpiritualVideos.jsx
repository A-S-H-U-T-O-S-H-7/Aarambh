...
import { getTrendingVideos, getLatestVideos, formatViews } from '@/lib/mockVideoData';
import VideoPlayerModal from './VideoPlayerModal';

// Brand-cohesive category tones
const CATEGORY_TONE = {
...
export default function SpiritualVideos() {
  ...
  const trendingVideos = getTrendingVideos().slice(0, 4);
  const latestVideos = getLatestVideos().slice(0, 6);
  ...
  return (
    <section className="py-6 lg:py-8 relative overflow-hidden bg-[#FBF3E7] dark:bg-[#15100C]">
      ...
      <div className="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Left: Trending (2x2) | Right: Latest Videos */}
              ...
              {trendingVideos.map((video, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-[4/3] w-full overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-black/35 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div
                          ...
                          style={{ background: 'linear-gradient(135deg, #E8742C, #F4B400)' }}
                        >
                    ...
                    >
                      {isLiked(video.id) ? (
                        <FaHeart className="w-3 h-3 text-[#E8674F]" />
                      ) : (
                        <FaRegHeart className="w-3 h-3 text-white/80" />
                      )}
                    </button>
                  </motion.div>
                );
